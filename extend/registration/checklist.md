...
| 16 | **Encryption** | All parameter attributes with keys prefixed `#` will be encrypted. If you pass senstive data in configuration (credentials, tokens) encourage to turn encryption on., `true` or `false` | &#9744; | `true` |
...
| 21 | **UI options** | Which UI helpers to use, any combaination of `tableInput`, `tableOutput`, `fileInput`, `fileOutput`| &#9744; | `tableInput, tableOutput` |
