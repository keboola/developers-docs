...
[Custom Science](/extend/custom-science/) and also [R] and [Python] transformations)
...
which are already registered. The structure of the body of both API calls is same.
...
When you run the request with a valid parameters, you should receive a response similar to this:
