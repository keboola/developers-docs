...
permalink: /cli/legacy/getting-started/
---
...
Let's say you want to download some data from Wikipedia. You can run [`kbc create`](/cli/legacy/commands/local/create/config/) 
...
{: .image-popup}
![Screenshot -- Duplicate a configuration directory](/cli/legacy/getting-started/configurations-copy-1.jpg)
...
{: .image-popup}
![Screenshot -- Fixed configuration directory](/cli/legacy/getting-started/configurations-copy-2.jpg)
