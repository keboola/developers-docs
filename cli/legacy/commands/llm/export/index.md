...
permalink: /cli/legacy/commands/llm/export/
redirect_from:
  - /cli/commands/llm/export/
---
...
The command must be run in a directory initialized with [kbc llm init](/cli/legacy/commands/llm/init/).
...
- [LLM Init](/cli/legacy/commands/llm/init/)
