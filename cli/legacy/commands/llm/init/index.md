...
permalink: /cli/legacy/commands/llm/init/
redirect_from:
  - /cli/commands/llm/init/
---
...
Use [kbc llm export](/cli/legacy/commands/llm/export/) after initialization to generate the AI-optimized project data.
...
- [LLM Export](/cli/legacy/commands/llm/export/)
