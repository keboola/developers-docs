---
title: Init Command
permalink: /cli/legacy/commands/sync/init/
redirect_from:
  - /cli/commands/sync/init/
---
...
**Initialize a new [local directory](/cli/legacy/structure/) and run the first [pull](/cli/legacy/commands/sync/pull/).**
...
Sets `true` to the `allowTargetEnv` field in the [manifest.json](/cli/legacy/structure/#manifest).
