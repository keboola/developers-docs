---
title: Create Table
permalink: /cli/legacy/commands/remote/table/create/
redirect_from:
...
- [Create a Bucket](/cli/legacy/commands/remote/create/bucket/)
- [Table Upload](/cli/legacy/commands/remote/table/upload/)
