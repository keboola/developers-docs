...
permalink: /cli/legacy/commands/local/encrypt/
redirect_from:
...
Encrypt all [unencrypted secrets](/overview/encryption/#encrypting-data-with-api) in the [local directory](/cli/legacy/structure/).
