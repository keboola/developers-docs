...
permalink: /cli/legacy/commands/local/create/row/
redirect_from:
  - /cli/commands/local/create/row/
---
...
Create a new configuration row in your [local directory](/cli/legacy/structure/) and assign it a unique ID (i.e., the [persist](/cli/legacy/commands/local/persist/)
...
*Tip: You can create a new configuration row by copying an existing one and running the [persist](/cli/legacy/commands/local/persist/) command.*
