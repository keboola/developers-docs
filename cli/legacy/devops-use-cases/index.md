...
permalink: /cli/legacy/devops-use-cases/
redirect_from:
  - /cli/devops-use-cases/
---
...
a [directory structure](/cli/legacy/structure/#directory-structure) with [JSON files](/cli/legacy/structure/#configurations).
...
{: .image-popup}
![branch_management.png](/cli/legacy/devops-use-cases/branch_management.png)
...
- Select only the main branch in this case.
  ...
  {: .image-popup}
  ![init.png](/cli/legacy/devops-use-cases/init.png)
...
{: .image-popup}
![project_deploy.png](/cli/legacy/devops-use-cases/project_deploy.png)
...
2. **Obtain the main branch ID**:
   ...
   *xxx/branch/{BRANCH_ID}/xx*).
   ...
   {: .image-popup}
   ![devtools.png](/cli/legacy/devops-use-cases/devtools.png)
...
{: .image-popup}
![devprod.png](/cli/legacy/devops-use-cases/devprod.png)
...
{: .image-popup}
![dev_prod_flow.png](/cli/legacy/devops-use-cases/dev_prod_flow.png)
