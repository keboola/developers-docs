...
[kbc dbt init](/cli/legacy/commands/dbt/init/) command creates a Snowflake [workspace](https://help.keboola.com/transformations/workspace/)
...
Single steps in this command can be run separately; see [kbc dbt generate](/cli/legacy/commands/dbt/generate/).
